...
1. Copy `unraid/my-cloud.xml` into `/boot/config/plugins/dockerMan/templates-user/` (or add the container manually with the same settings), or install from Community Applications once published.
2. Map:
